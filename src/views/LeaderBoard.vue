...
<template>
  <div class="min-h-screen bg-gradient-to-b from-green-100 to-white p-6">
    <header class="flex justify-center gap-4 mb-6 relative">
      ...
      <Button label="👍 Like" class="bg-pink-400 border-b-4 border-pink-600 active:bg-pink-600" :class="{ 'border-b-4 border-white': !changeTab }" @click="changeTab = false" />
    ...
    <section class="max-w-3xl mx-auto">
      ...
      <div v-else class="transition-all duration-300">
        <div
          ...
          <div class="text-pink-500 font-bold text-lg">👍 {{ quiz.like }}</div>
        </div>
      </div>
    </section>
  </div>
