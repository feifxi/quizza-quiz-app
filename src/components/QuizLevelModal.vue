...
<template>
  <div
    ...
    <div
      ...
      <!-- Level -->
      <div
        class="flex-1 flex flex-col p-3 items-center gap-2 border-l-3 border-neutral-300 max-w-55 overflow-y-scroll">
        <div
          v-for="(level, index) of quiz.levels"
          ...
          <RouterLink
            ...
            "
            :class="
              'border-3 text-3xl font-bold size-25 flex items-center justify-center rounded-full hover:scale-110 transition-all ' +
              (index > 0
